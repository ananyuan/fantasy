...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			//��ɨ�����ϵĽǣ��ܹ�8������
			paint.setColor(resources.getColor(R.color.lightgreen));
...
//			canvas.drawText(getResources().getString(R.string.scan_text), frame.left, (float) (frame.top - (float)TEXT_PADDING_TOP *density), paint);
