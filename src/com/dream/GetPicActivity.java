...
public class GetPicActivity extends Activity {
	...
	private GetImgGroupAdapter adapter;
	...
	private Handler mHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case SCAN_OK:
				...
				adapter = new GetImgGroupAdapter(GetPicActivity.this, list = subGroupOfImage(mGruopMap), mGroupGridView);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mGroupGridView = (GridView) findViewById(R.id.image_group_grid);
		initTitleView();
		...
		mGroupGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent mIntent = new Intent(GetPicActivity.this, ShowSelectImageActivity.class);
	...
	private void getImages() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				ContentResolver mContentResolver = GetPicActivity.this.getContentResolver();
